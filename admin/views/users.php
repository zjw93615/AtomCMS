  ...
  <div class="col-md-9">
    ...
    <form action="index.php?page=users&id=<?php echo $opened['id']; ?>" method="post" role="form">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="last" value="<?php echo $opened['last'] ?>" id="last" placeholder="Last Name" autocomplete="off">
      </div>
      <div class="form-group">
        <label for="email">Email Address:</label>
        <input class="form-control" type="email" name="email" value="<?php echo $opened['email'] ?>" id="email" placeholder="Email Address" autocomplete="off">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label for="passworvb">Verify Password:</label>
